export default [
  {
    inputs: [
      { internalType: 'address', name: 'hashi', type: 'address' },
      { internalType: 'address', name: 'yaho_', type: 'address' },
  ...
  { inputs: [], name: 'CallFailed', type: 'error' },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'expectedChainId', type: 'uint256' }
    ],
  ...
  { inputs: [], name: 'ThresholdNotMet', type: 'error' },
  {
    anonymous: false,
    inputs: [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'receiver', type: 'address' },
          { internalType: 'bytes', name: 'data', type: 'bytes' },
          { internalType: 'contract IReporter[]', name: 'reporters', type: 'address[]' },
          { internalType: 'contract IAdapter[]', name: 'adapters', type: 'address[]' }
        ],
        internalType: 'struct Message',
        name: 'message',
        type: 'tuple'
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'sourceChainId', type: 'uint256' },
      { internalType: 'address', name: 'dispatcherAddress', type: 'address' },
